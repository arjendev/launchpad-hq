...
function readPackageJsonPort(projectPath: string): DetectedPort | null {
  ...
  try {
    ...
    const scripts = [pkg.scripts.dev, pkg.scripts.start].filter(Boolean) as string[];
